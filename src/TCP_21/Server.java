...
public class Server {
	...
	public class RcvPic extends Thread {
		...
		public void run() {
			...
			try {
				...
				BufferedOutputStream outputStream = new BufferedOutputStream(new FileOutputStream("C://Users/a2055/Desktop/5.jpg"));
				int readin;
	...
	public class Communication extends Thread {
		...
		public Communication(Socket socket) {
			...
			try {
				...
				System.out.println("Server端異常: " + e.getMessage());
			}
		}
		...
		public void run() {
			...
			try {
				...
				System.out.println("Server端接收異常: " + e.getMessage());
			}
		}
	}
			...
			if (e.getSource() == btnSend) {
				if (graph) {
					...
					try {
						...
						System.out.println("Server端傳送異常: " + ex.getMessage());
					}
				}
	...
	public static void chooseFile() {
		...
		f.setCurrentDirectory(new File("C://Users/a2055/Desktop/0ws2YFTJcguqJ5hF1Hp3V8ELwZfAP_rMiLU2UYi1NlE.jpg"));
