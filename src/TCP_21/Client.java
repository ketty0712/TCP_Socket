...
public class Client {
    ...
    /**
     * 前面的操作都是傳送文字指令或資訊給連線的另一端。 現在需要適當的改寫一下，就可以作檔案傳送。
    ...
    public void Receiver2(final BufferedInputStream inputStream) {
        new Thread() {
            @Override
            public void run() {
                super.run();
                try {
                    BufferedOutputStream outputStream = new BufferedOutputStream(
                            new FileOutputStream("C://Users/a2055/Desktop/4.jpg"));
                    int readin;
